    ...
    <div className="bg-white">
      ...
      <section>
        ...
        <div className=" max-w-7xl">
          <h4 className="text-[#023B66] font-alternate font-medium md:pl-32 tracking-widest uppercase  md:pt-12 text-5xl md:text-7xl lg:text-[145px] leading-none">
            OUR JOURNEY
          </h4>
        </div>
        ...
        <div className="relative bg-white py-12 md:py-16 lg:py-24 px-4 md:px-8 lg:px-32">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
              ...
              {/* Right Image */}
              <div className="relative order-1 lg:order-2 -mt-10 md:-mt-48 lg:-mt-40 z-20 w-full lg:w-[30vw] lg:absolute lg:right-0">
                <Image
